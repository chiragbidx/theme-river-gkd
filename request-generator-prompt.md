...
2. Feature Intent
3. In-Scope Functional Requirements (numbered)
4. Non-Functional Requirements
5. Rebranding Requirements (main page + auth + dashboard + shared messaging)
6. Main Page Section Plan
7. Out-of-Scope
8. Data and Business Rules (entities/lifecycle/constraints as outcomes)
9. User Flows and Interaction Expectations
10. Validation and Error Handling Expectations
11. Access and Permission Expectations
12. UX Requirements (screens, forms/tables, filters/search, states)
13. Environment/Dependency Notes (only if required by outcomes)
14. Acceptance Criteria (testable checklist)
